...
class Mage_Adminhtml_Block_Dashboard extends Mage_Adminhtml_Block_Template
{
    ...
    {
        $this->setChild('lastInvoices',
                $this->getLayout()->createBlock('adminhtml/dashboard_invoices_last')
        );
        $this->setChild('lastUnpaid',
            $this->getLayout()->createBlock('adminhtml/dashboard_invoices_unpaid')
        );

        $this->setChild('lastMonth',
            $this->getLayout()->createBlock('adminhtml/dashboard_invoices_month')
        );
